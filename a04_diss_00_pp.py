...
f_gl='./raw/ref/gl_dissociation.txt'
fd_out='./out/a04_diss_00_pp'
...
for sample in l_sample:
	...
	#4. score
	sc.tl.score_genes(adata, gene_list=l_diss, score_name='diss')
	...
	#6. PCA
	sc.pp.regress_out(adata, ['n_counts', 'perc_others', 'diss'])
